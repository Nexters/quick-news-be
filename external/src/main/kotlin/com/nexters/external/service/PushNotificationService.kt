...
class PushNotificationService(
     ...
     * 특정 사용자에게 알림 발송
     */
    fun sendToUser(userId: Long, title: String, body: String, data: Map<String, String> = emptyMap()): Boolean {
     ...
     * 단일 토큰으로 알림 발송
     */
    fun sendNotification(token: String, title: String, body: String, data: Map<String, String> = emptyMap()): Boolean {
        return try {
     ...
     * FCM 토큰 등록/갱신
     */
    fun registerToken(userId: Long, deviceToken: String, deviceType: DeviceType): Boolean {
        return try {
            // 기존 토큰이 있는지 확인
