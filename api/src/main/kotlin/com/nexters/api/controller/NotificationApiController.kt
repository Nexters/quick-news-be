...
class NotificationApiController(
    ...
    @PostMapping("/token")
    fun registerToken(@RequestBody request: TokenRegistrationApiRequest): ResponseEntity<ApiResponse<String>> {
        val success = pushNotificationService.registerToken(
    ...
    @DeleteMapping("/token")
    fun unregisterToken(@RequestParam deviceToken: String): ResponseEntity<ApiResponse<String>> {
    ...
    fun unregisterAllUserTokens(@PathVariable userId: Long): ResponseEntity<ApiResponse<String>> {
    ...
    fun sendToUser(
        ...
        val success = pushNotificationService.sendToUser(
            userId = userId,
            title = request.title,
            body = request.body,
            data = request.data
    ...
    fun sendToToken(
        ...
        val success = pushNotificationService.sendNotification(
            token = token,
            title = request.title,
            body = request.body,
            data = request.data
